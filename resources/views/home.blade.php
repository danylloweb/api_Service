...
<head>
	...
	<link rel="stylesheet" href="{{ asset('public/css/linea-icon.css') }}" />
	<link rel="stylesheet" href="{{ asset('public/css/fancy-buttons.css') }}" />
	...
	<link rel="stylesheet" href="{{ asset('public/css/jquery.vegas.css') }}" />
	<link rel="stylesheet" href="{{ asset('public/css/baraja.css') }}" />
	...
	<link rel="stylesheet" id="scheme-source" href="{{ asset('public/css/schemes/gray.css') }}" />
				...
				<div class="col-lg-12">
						...
						<ul id="card-ul" class="features-hold baraja-container">
							...
							<li class="single-feature" title="Card style">
								<img src="{{ asset('public/images/5.jpg') }}" alt="" class="feature-image" /><!-- Feature Icon -->
							...
							<li class="single-feature" title="50+ SVG Icon included">
								<img src="{{ asset('public/images/2.jpg') }}" alt="" class="feature-image" /><!-- Feature Icon -->
							...
							<li class="single-feature" title="MailChimp Ready">
								<img src="{{ asset('public/images/3.jpg') }}" alt="" class="feature-image" /><!-- Feature Icon -->
							...
							<li class="single-feature" title="4 home style">
								<img src="{{ asset('public/images/4.jpg') }}" alt="" class="feature-image" /><!-- Feature Icon -->
							...
							<li class="single-feature" title="Ajax contact form">
								<img src="{{ asset('public/images/6.jpg') }}" alt="" class="feature-image" /><!-- Feature Icon -->
							...
							<li class="single-feature" title="unlimited Google fonts">
								<img src="{{ asset('public/images/7.jpg') }}" alt="" class="feature-image" /><!-- Feature Icon -->
							...
							<li class="single-feature" title="Feature heading">
								<img src="{{ asset('public/images/8.jpg') }}" alt="" class="feature-image" /><!-- Feature Icon -->
		...
		<div class="container step animated" data-animation="bounceInLeft" data-animation-delay="700">
			<div class="row">
				...
				<div class="col-md-4 step-img">
					<img src="{{ asset('public/images/note.png') }}" alt="" /> <!-- Step Photo Here -->
				</div>
			</div>
		</div>
	</section>
	...
	<section id="step-2" class="section-step step-even step-wrap">
		<div class="container step animated" data-animation="bounceInRight" data-animation-delay="700">
			<div class="row">
				...
				<!-- Step Description Ends -->
				<div class="col-md-4 step-img">
					<img src="{{ asset('public/images/desk.png') }}" alt="" /> <!-- Step Photo Here -->
				</div>
			</div>
		</div>
	</section>
			...
			<div class="row porfolio-container">
				...
				<div class="col-md-4 col-sm-4 col-xs-6">
					<div class="screenshot">
						<div class="photo-box">
							<img src="{{ asset('public/images/7.jpg') }}" alt="" />
				...
				<div class="col-md-4 col-sm-4 col-xs-6">
					<div class="screenshot">
						<div class="photo-box">
							<img src="{{ asset('public/images/6.jpg') }}" alt="" />
							<div class="photo-overlay">
				...
				<div class="col-md-8 col-md-offset-2">
					...
					<div id="bx-pager" class="client-photos">
						<a data-slide-index="0" href="" class="photo-hold">
							<span class="photo-bg">
								<img src="{{ asset('public/images/client_1.jpg') }}" alt="" /> <!-- Client photo 1 -->
							</span>
						</a>
						<a data-slide-index="1" href="" class="photo-hold">
							<span class="photo-bg">
								<img src="{{ asset('public/images/client_2.jpg') }}" alt="" /> <!-- Client photo 2 -->
							</span>
						</a>
						<a data-slide-index="2" href="" class="photo-hold">
							<span class="photo-bg">
								<img src="{{ asset('public/images/client_3.jpg') }}" alt="" /> <!-- Client photo 3 -->
							</span>
						</a>
					</div>
				</div>
...
<script type="text/javascript" src="{{ asset('public/js/jquery.baraja.js') }}"></script>
<script type="text/javascript" src="{{ asset('public/js/jquery.vegas.min.js') }}"></script>
...
<script type="text/javascript" src="{{ asset('public/js/jquery.nicescroll.min.js') }}"></script>
...
<script type="text/javascript" src="{{ asset('public/js/jquery.fitvids.js') }}"></script>
...
$(window).ready(function() {
	...
	$.vegas('slideshow', {
	  backgrounds:[
		{ src:'{{ asset('public/images/bg-slider/bg-1.jpg') }}', fade:1000 },
		{ src:'{{ asset('public/images/bg-slider/bg-2.jpg') }}', fade:1000 },
		{ src:'{{ asset('public/images/bg-slider/bg-3.jpg') }}', fade:1000 }
	  ]
	})();
});
</script>
